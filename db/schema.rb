...
ActiveRecord::Schema.define(version: 2021_03_09_191902) do
  ...
  ii = Item.first.invoice_items.first
  discount = BulkDiscount.new(merchant_id: 1, item_quantity:1, percent_off: 20)
